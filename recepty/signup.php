            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        ...
                        <form method="post" action="user_registration_script.php" id="feedBackForm">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" placeholder="Имя" required="true">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" placeholder="Электронная почта" required="true" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                            </div> 
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-dark"><a class="btn btn-dark" style="color: #0f0f0f" value= "Зарегистрироваться";>Зарегистрироваться</a></button>
                            </div>
                        </form>
                </div>
            </div>
